                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('course-video.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf

                                    <div class="row md-3 mt-3 mb-3">
                                        <label class="col-md-3"></label>
                                        <div class="col-md-9" style="text-align: right">
                                            <a href="{{url('/course-edit'.$course_id)}}" class="btn btn-outline-secondary float-lg-right" ><i class="fa-solid fa-chevron-left"></i></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row md-3 mt-3 mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control @error('videoLink') is-invalid @enderror" name="videoLink" placeholder="Paste the video link"/>
                                    ...
                                    <div class="row md-3 mt-3 mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Type video title"/>
                                    ...
                                    <div class="row md-3 mt-3 mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control @error('duration') is-invalid @enderror" name="duration" placeholder="Ex: 2h:10m:40s"/>
                                    ...
                                    <div class="col-md-12" style="text-align: center">
                                        <input type="submit" class="btn btn-secondary @error('submit') is-invalid @enderror" name="submit" value="Upload"/>
