                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('admin-list.index')}}" method="post">
                                    @csrf
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="rounded-button" style="text-align: center">
                                                        <form action="{{url('admin-list/'.$user->id)}}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                    ...
                                    @else
                                        <h3 style="text-align: center; color: red">There is no Admin to show !!!</h3>
                                    @endif
