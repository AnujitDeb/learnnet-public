...
<div class="container-fluid bg-dark text-white py-5 px-sm-3 px-lg-5" style="margin-top: 90px;">
    <div class="row pt-5">
        <div class="col-lg-7 col-md-12">
            <div class="row">
                <div class="col-md-6 mb-5">
                    <h3 class="text-primary text-uppercase mb-4" style="letter-spacing: 5px;">Get In Touch</h3>
                    <p><i class="fa fa-map-marker-alt mr-2"></i>Dhanmondi 27, Dhaka, Bangladesh</p>
                    <p><i class="fa fa-phone-alt mr-2"></i>+880 1966 509310</p>
                    <p><i class="fa fa-envelope mr-2"></i>niazahmed.net@gmail.com</p>
                ...
                <div class="col-md-6 mb-5">
                    <h3 class="text-primary text-uppercase mb-4" style="letter-spacing: 5px;">Our Courses</h3>
        ...
        <div class="col-lg-5 col-md-12 mb-5">
            <h3 class="text-primary text-uppercase mb-4" style="letter-spacing: 5px;">Newsletter</h3>
...
<div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5"
    ...
    <div class="row">
        <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
            <p class="m-0 text-white">&copy; <a href="#">LEARNNET</a>. All Rights Reserved. Designed by
                LEARNNET</a>
            </p>
        </div>
...
<script src="frontendAsset/js/vendor/jquery-3.5.1.min.js"></script>
<script src="frontendAsset/js/vendor/bootstrap.bundle.min.js"></script>
<script src="frontendAsset/js/vendor/OverlayScrollbars.min.js"></script>
<script src="frontendAsset/js/vendor/autoComplete.min.js"></script>
<script src="frontendAsset/js/vendor/clamp.min.js"></script>
<script src="frontendAsset/icon/acorn-icons.js"></script>
<script src="frontendAsset/icon/acorn-icons-interface.js"></script>
<script src="frontendAsset/icon/acorn-icons-learning.js"></script>
<script src="frontendAsset/js/vendor/glide.min.js"></script>
<script src="frontendAsset/js/vendor/Chart.bundle.min.js"></script>
<script src="frontendAsset/js/vendor/jquery.barrating.min.js"></script>
<!-- Vendor Scripts End -->
<!-- Template Base Scripts Start -->
<script src="frontendAsset/js/base/helpers.js"></script>
<script src="frontendAsset/js/base/globals.js"></script>
<script src="frontendAsset/js/base/nav.js"></script>
<script src="frontendAsset/js/base/search.js"></script>
<script src="frontendAsset/js/base/settings.js"></script>
<!-- Template Base Scripts End -->
<!-- Page Specific Scripts Start -->
<script src="frontendAsset/js/cs/glide.custom.js"></script>
<script src="frontendAsset/js/cs/charts.extend.js"></script>
<script src="frontendAsset/js/pages/dashboard.elearning.js"></script>
<script src="frontendAsset/js/common.js"></script>
<script src="frontendAsset/js/scripts.js"></script>
